...
- Missing references for links: 
     * [`https://w3c.github.io/html/`](https://w3c.github.io/html/)
- Inconsistent references for links: 
...
- Missing references for links: 
     ...
     * [`https://www.w3.org/TR/css3-values/`](https://www.w3.org/TR/css3-values/)
- Inconsistent references for links: 
     * [`https://html.spec.whatwg.org/`](https://html.spec.whatwg.org/), related reference "2dcontext" uses URL [`http://www.w3.org/TR/2dcontext/`](http://www.w3.org/TR/2dcontext/)
...
- Inconsistent references for links: 
     * [`https://html.spec.whatwg.org/`](https://html.spec.whatwg.org/), related reference "HTML" uses URL [`http://www.whatwg.org/specs/web-apps/current-work/multipage/`](http://www.whatwg.org/specs/web-apps/current-work/multipage/)
