...
- Crawled version: [Latest published version](https://www.w3.org/TR/2018/CR-SVG2-20181004/) (Sat Apr 20 2019)
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/WD-ambient-light-20190307/) (7 March 2019)
...
## Beacon {data-spec=true data-anomaly=true data-noIdlContent=true data-missingLinkRef=true data-inconsistentRef=true}
...
## Content Security Policy Level 3 {data-spec=true data-anomaly=true data-noIdlContent=true data-missingLinkRef=true}
...
## CSS Animations Level 1 {data-spec=true data-anomaly=true data-noIdlContent=true data-missingLinkRef=true data-inconsistentRef=true}
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2018/CR-css-contain-1-20181108/) (8 November 2018)
...
## CSS Counter Styles Level 3 {data-spec=true data-anomaly=true data-noIdlContent=true data-inconsistentRef=true}
...
## CSS Device Adaptation Module Level 1 {data-spec=true data-anomaly=true data-noRefToWebIDL=true data-noIdlContent=true data-missingLinkRef=true data-inconsistentRef=true}
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2018/WD-css-easing-1-20181009/) (9 October 2018)
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2018/CR-css-flexbox-1-20181119/) (19 November 2018)
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2018/WD-css-page-3-20181018/) (18 October 2018)
...
## CSS Painting API Level 1 {data-spec=true data-anomaly=true data-noIdlContent=true data-missingLinkRef=true data-inconsistentRef=true}
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/WD-css-pseudo-4-20190225/) (25 February 2019)
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/CR-css-scroll-snap-1-20190319/) (19 March 2019)
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2018/WD-css-text-3-20181212/) (12 December 2018)
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/CR-css-transforms-1-20190214/) (14 February 2019)
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2018/WD-css-transitions-1-20181011/) (11 October 2018)
...
## CSS Typed OM Level 1 {data-spec=true data-anomaly=true data-noIdlContent=true data-missingLinkRef=true data-inconsistentRef=true}
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/WD-css-values-4-20190131/) (31 January 2019)
...
## DeviceOrientation Event Specification {data-spec=true data-anomaly=true data-noIdlContent=true data-missingLinkRef=true data-inconsistentRef=true}

### Spec info {.info}

- Crawled version: [Latest published version](https://www.w3.org/TR/2019/WD-orientation-event-20190416/) (16 April 2019)
...
## DOM Parsing and Serialization {data-spec=true data-anomaly=true data-noIdlContent=true data-missingLinkRef=true}
...
## Encoding {data-spec=true data-anomaly=true data-noIdlContent=true}
...
## File API {data-spec=true data-anomaly=true data-noIdlContent=true}

### Spec info {.info}

- Crawled version: [Latest published version](https://www.w3.org/TR/2018/WD-FileAPI-20181106/) (6 November 2018)
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2018/WD-filter-effects-1-20181218/) (18 December 2018)
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/WD-generic-sensor-20190307/) (7 March 2019)
...
## Geometry Interfaces Module Level 1 {data-spec=true data-anomaly=true data-noIdlContent=true data-inconsistentRef=true}
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/WD-gyroscope-20190307/) (7 March 2019)
...
## Identifiers for WebRTC's Statistics API {data-spec=true data-anomaly=true data-noRefToWebIDL=true data-noIdlContent=true data-inconsistentRef=true}
...
## Indexed Database API 2.0 {data-spec=true data-anomaly=true data-noIdlContent=true data-inconsistentRef=true}
...
## Input Events Level 2 {data-spec=true data-anomaly=true data-noIdlContent=true data-inconsistentRef=true}
...
## Intersection Observer {data-spec=true data-anomaly=true data-noIdlContent=true data-missingLinkRef=true data-inconsistentRef=true}

### Spec info {.info}

- Crawled version: [Latest published version](https://www.w3.org/TR/2018/WD-intersection-observer-20181106/) (6 November 2018)
...
## Long Tasks API 1 {data-spec=true data-anomaly=true data-noIdlContent=true data-missingLinkRef=true data-inconsistentRef=true}
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/WD-magnetometer-20190307/) (7 March 2019)
...
## Media Source Extensions™ {data-spec=true data-anomaly=true data-noIdlContent=true data-missingLinkRef=true}
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2018/WD-motion-1-20181218/) (18 December 2018)
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/NOTE-selectors-nonelement-1-20190402/) (2 April 2019)
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/WD-orientation-sensor-20190307/) (7 March 2019)
...
## Paint Timing 1 {data-spec=true data-anomaly=true data-noIdlContent=true data-missingLinkRef=true data-inconsistentRef=true}
...
## Payment Handler API {data-spec=true data-anomaly=true data-noIdlContent=true data-missingLinkRef=true}
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/WD-payment-method-basic-card-20190412/) (April 2019 )
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/WD-performance-timeline-2-20190329/) (March 2019 )
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2018/WD-pointerlock-2-20181106/) (06 November 2018)
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/WD-proximity-20190305/) (5 March 2019)
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2018/WD-push-api-20181026/) (26 October 2018)
...
## Remote Playback API {data-spec=true data-anomaly=true data-noIdlContent=true}
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/WD-resource-timing-2-20190307/) (March 2019 )
...
## Screen Capture {data-spec=true data-anomaly=true data-noIdlContent=true data-inconsistentRef=true}
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2018/REC-selectors-3-20181106/) (06 November 2018)
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2018/WD-selectors-4-20181121/) (21 November 2018)
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/WD-screen-orientation-20190416/) (April 2019 )
...
## Touch Events {data-spec=true data-anomaly=true data-noIdlContent=true}
...
## User Timing Level 2 {data-spec=true data-anomaly=true data-noIdlContent=true}
...
## Web Animations {data-spec=true data-anomaly=true data-noIdlContent=true data-missingLinkRef=true data-inconsistentRef=true}

### Spec info {.info}

- Crawled version: [Latest published version](https://www.w3.org/TR/2018/WD-web-animations-1-20181011/) (11 October 2018)
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/WD-appmanifest-20190418/) (Living Document)
...
## Web Authentication: An API for accessing Public Key Credentials Level 1 {data-spec=true data-anomaly=true data-noIdlContent=true data-inconsistentRef=true}

### Spec info {.info}

- Crawled version: [Latest published version](https://www.w3.org/TR/2019/REC-webauthn-1-20190304/) (4 March 2019)
...
## Web MIDI API {data-spec=true data-anomaly=true data-noIdlContent=true data-inconsistentRef=true}
...
## Web Workers {data-spec=true data-anomaly=true data-noIdlContent=true data-missingLinkRef=true data-inconsistentRef=true}
...
## WebRTC 1.0: Real-time Communication Between Browsers {data-spec=true data-anomaly=true data-noIdlContent=true data-missingLinkRef=true data-inconsistentRef=true}
...
## WebVTT: The Web Video Text Tracks Format {data-spec=true data-anomaly=true data-noIdlContent=true data-missingLinkRef=true data-inconsistentRef=true}

### Spec info {.info}

- Crawled version: [Latest published version](https://www.w3.org/TR/2019/CR-webvtt1-20190404/) (4 April 2019)
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/WD-webxr-20190205/) (5 February 2019)
...
## Worklets Level 1 {data-spec=true data-anomaly=true data-noIdlContent=true}
