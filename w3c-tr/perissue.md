...
- [File API](https://www.w3.org/TR/2017/WD-FileAPI-20171026/) links to [`https://w3c.github.io/html/`](https://w3c.github.io/html/) but does not list it in its references
...
- [Scalable Vector Graphics (SVG) 2](https://www.w3.org/TR/2016/CR-SVG2-20160915/) links to:
    ...
    * [`https://w3c.github.io/html/`](https://w3c.github.io/html/) but does not list it in its references
...
=> 159 missing references for links found in 55 specifications
...
- [Geometry Interfaces Module Level 1](http://www.w3.org/TR/2014/CR-geometry-1-20141125/) links to [`https://html.spec.whatwg.org/`](https://html.spec.whatwg.org/) but related reference "2dcontext" uses URL [`http://www.w3.org/TR/2dcontext/`](http://www.w3.org/TR/2dcontext/)
...
- [Web Workers](http://www.w3.org/TR/2015/WD-workers-20150924/) links to [`https://www.w3.org/TR/domcore/`](https://www.w3.org/TR/domcore/) but related reference "DOM4" uses URL [`http://www.w3.org/TR/dom/`](http://www.w3.org/TR/dom/)
- [WebDriver](https://www.w3.org/TR/2017/CR-webdriver-20170330/) links to:
    ...
    * [`https://www.w3.org/TR/html5/`](https://www.w3.org/TR/html5/) but related reference "HTML" uses URL [`https://html.spec.whatwg.org/multipage/`](https://html.spec.whatwg.org/multipage/)
- [WebGL Specification](https://www.khronos.org/registry/webgl/specs/latest/1.0/) links to [`https://html.spec.whatwg.org/`](https://html.spec.whatwg.org/) but related reference "HTML" uses URL [`http://www.whatwg.org/specs/web-apps/current-work/multipage/`](http://www.whatwg.org/specs/web-apps/current-work/multipage/)
...
=> 144 inconsistent references for links found in 59 specifications
