...
- `Screen` used in [Media Capabilities](https://wicg.github.io/media-capabilities/), [The Screen Orientation API](https://www.w3.org/TR/2019/WD-screen-orientation-20190627/)
...
- `ServiceWorkerUpdateViaCache` used in [Web App Manifest](https://www.w3.org/TR/2019/WD-appmanifest-20190702/)
...
- `[object Object]` defined in [CSS Animation Worklet API](https://wicg.github.io/animation-worklet/) and [CSS Painting API Level 1](https://www.w3.org/TR/2018/CR-css-paint-api-1-20180809/) and [Web Audio API](https://www.w3.org/TR/2018/CR-webaudio-20180918/) and [Worklets Level 1](http://www.w3.org/TR/2016/WD-worklets-1-20160607/)
...
- ["MediaStream Image Capture"](https://www.w3.org/TR/2017/WD-image-capture-20170621/) uses:
...
- [Background Fetch](https://wicg.github.io/background-fetch/) uses `ImageResource` but does not reference [Web App Manifest](https://www.w3.org/TR/2019/WD-appmanifest-20190702/)
...
=> 17 missing references for IDL definitions found in 6 specifications
...
- [Performance Timeline Level 2](https://www.w3.org/TR/2019/WD-performance-timeline-2-20190626/) links to [`https://w3c.github.io/timing-entrytypes-registry/`](https://w3c.github.io/timing-entrytypes-registry/) but does not list it in its references
...
- [Preload](https://www.w3.org/TR/2019/CR-preload-20190626/) links to [`https://w3c.github.io/webappsec/specs/content-security-policy/`](https://w3c.github.io/webappsec/specs/content-security-policy/) but does not list it in its references
...
=> 609 missing references for links found in 148 specifications
