...
- [CSS Table Module Level 3](https://www.w3.org/TR/css-tables-3/): `Error: Crawl took too long Error: Crawl took too long
...
- [Payment Method: Basic Card](https://www.w3.org/TR/2019/WD-payment-method-basic-card-20190330/)
- [Payment Request API](https://www.w3.org/TR/2018/CR-payment-request-20180830/)
- [Performance Timeline Level 2](https://www.w3.org/TR/2019/WD-performance-timeline-2-20190329/)
...
- [WebXR Device API](https://www.w3.org/TR/2019/WD-webxr-20190205/)
- [Worklets Level 1](http://www.w3.org/TR/2016/WD-worklets-1-20160607/)
- [XMLHttpRequest Standard](https://xhr.spec.whatwg.org/)

=> 140 specifications found
...
- `Document` used in [CORS and RFC1918](https://wicg.github.io/cors-rfc1918/), [Page Visibility Level 2](https://www.w3.org/TR/2017/PR-page-visibility-2-20171017/)
- `Element` used in [CSS Shadow Parts](https://drafts.csswg.org/css-shadow-parts-1/)
- `EventHandler` used in [Compatibility Standard](https://compat.spec.whatwg.org/), [Page Visibility Level 2](https://www.w3.org/TR/2017/PR-page-visibility-2-20171017/)
...
- `HTMLInputElement` used in [HTML Media Capture](https://www.w3.org/TR/2018/REC-html-media-capture-20180201/)
...
- `MediaStreamTrack` used in [MediaStreamTrack Content Hints](https://www.w3.org/TR/2018/WD-mst-content-hint-20180703/)
...
- [WebVTT: The Web Video Text Tracks Format](https://www.w3.org/TR/2018/CR-webvtt1-20180510/) links to:
    ...
    * [`https://www.w3.org/TR/css3-align/`](https://www.w3.org/TR/css3-align/) but does not list it in its references
    * [`https://www.w3.org/TR/css3-selectors/`](https://www.w3.org/TR/css3-selectors/) but does not list it in its references
- [WebXR Device API](https://www.w3.org/TR/2019/WD-webxr-20190205/) links to:
    * [`https://www.w3.org/TR/hr-time/`](https://www.w3.org/TR/hr-time/) but does not list it in its references
...
=> 626 missing references for links found in 147 specifications
...
- [Pointer Events](https://www.w3.org/TR/2019/PR-pointerevents2-20190221/) links to [`https://www.w3.org/TR/html51/`](https://www.w3.org/TR/html51/) but related reference "HTML" uses URL [`https://html.spec.whatwg.org/multipage/`](https://html.spec.whatwg.org/multipage/)
...
=> 243 inconsistent references for links found in 126 specifications
