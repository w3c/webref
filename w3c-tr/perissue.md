...
- `WorkerType` used in [Service Workers 1](https://www.w3.org/TR/2017/WD-service-workers-1-20171102/), [Web App Manifest](https://www.w3.org/TR/2018/WD-appmanifest-20180830/)
...
- [Background Fetch](https://wicg.github.io/background-fetch/) uses `ImageResource` but does not reference [Web App Manifest](https://www.w3.org/TR/2018/WD-appmanifest-20180830/)
...
=> 62 missing references for IDL definitions found in 28 specifications
...
- [Presentation API](https://www.w3.org/TR/2017/CR-presentation-api-20170601/) links to [`https://w3c.github.io/webappsec-mixed-content/`](https://w3c.github.io/webappsec-mixed-content/) but does not list it in its references
...
- [Secure Contexts](https://www.w3.org/TR/2016/CR-secure-contexts-20160915/) links to [`https://w3c.github.io/webappsec-mixed-content/`](https://w3c.github.io/webappsec-mixed-content/) but does not list it in its references
...
=> 606 missing references for links found in 142 specifications
...
- [Web App Manifest](https://www.w3.org/TR/2018/WD-appmanifest-20180830/) links to [`https://w3c.github.io/ServiceWorker/`](https://w3c.github.io/ServiceWorker/) but related reference "SERVICE-WORKERS-1" uses URL [`https://www.w3.org/TR/service-workers-1/`](https://www.w3.org/TR/service-workers-1/)
- [Web Audio API](https://www.w3.org/TR/2018/WD-webaudio-20180619/) links to:
...
=> 281 inconsistent references for links found in 132 specifications
