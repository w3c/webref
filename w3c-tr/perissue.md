...
- `DOMRectReadOnly` used in [Accelerated Shape Detection in Images](https://wicg.github.io/shape-detection-api/), [CSSOM View Module](http://www.w3.org/TR/2016/WD-cssom-view-1-20160317/)
...
- [WebAssembly JavaScript Interface](https://www.w3.org/TR/2018/WD-wasm-js-api-1-20180215/) uses `Worklet` but does not reference [CSS Painting API Level 1](https://www.w3.org/TR/2018/WD-css-paint-api-1-20180410/) or [Web Audio API](https://www.w3.org/TR/2018/WD-webaudio-20180619/) or [Worklets Level 1](http://www.w3.org/TR/2016/WD-worklets-1-20160607/)
...
=> 60 missing references for IDL definitions found in 29 specifications
...
- [CSS Inline Layout Module Level 3](https://www.w3.org/TR/2018/WD-css-inline-3-20180802/) links to:
    * [`https://www.w3.org/TR/css3-break/`](https://www.w3.org/TR/css3-break/) but does not list it in its references
...
- [Scalable Vector Graphics (SVG) 2](https://www.w3.org/TR/2016/CR-SVG2-20160915/) links to:
    ...
    * [`https://w3c.github.io/aria/html-aam/html-aam.html`](https://w3c.github.io/aria/html-aam/html-aam.html) but does not list it in its references
...
- [CSS Inline Layout Module Level 3](https://www.w3.org/TR/2018/WD-css-inline-3-20180802/) links to [`https://www.w3.org/TR/css3-values/`](https://www.w3.org/TR/css3-values/) but related reference "CSS-VALUES-3" uses URL [`https://www.w3.org/TR/css-values-3/`](https://www.w3.org/TR/css-values-3/)
...
=> 298 inconsistent references for links found in 138 specifications
