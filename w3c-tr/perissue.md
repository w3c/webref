...
- `PromptResponseObject` used in [Web App Manifest](https://www.w3.org/TR/2018/WD-appmanifest-20180202/)
...
- `ServiceWorkerRegistration` defined in [Service Workers 1](https://www.w3.org/TR/2017/WD-service-workers-1-20171102/) and [Web App Manifest](https://www.w3.org/TR/2018/WD-appmanifest-20180202/)
- `ShadowRoot` defined in [Shadow DOM](https://www.w3.org/TR/2017/WD-shadow-dom-20170905/) and [W3C DOM 4.1](https://www.w3.org/TR/2018/WD-dom41-20180201/)
- `ShadowRootMode` defined in [Shadow DOM](https://www.w3.org/TR/2017/WD-shadow-dom-20170905/) and [W3C DOM 4.1](https://www.w3.org/TR/2018/WD-dom41-20180201/)
...
- [Shadow DOM](https://www.w3.org/TR/2017/WD-shadow-dom-20170905/) uses:
    * `DocumentOrShadowRoot` but does not reference [W3C DOM 4.1](https://www.w3.org/TR/2018/WD-dom41-20180201/)
...
- [WebAssembly JavaScript Interface](https://webassembly.github.io/spec/js-api/index.html) uses `Worklet` but does not reference [CSS Painting API Level 1](http://www.w3.org/TR/2016/WD-css-paint-api-1-20160607/) or [Worklets Level 1](http://www.w3.org/TR/2016/WD-worklets-1-20160607/)
...
- [Web App Manifest](https://www.w3.org/TR/2018/WD-appmanifest-20180202/) links to:
...
=> 169 inconsistent references for links found in 64 specifications
