...
- [MediaStream Recording](https://www.w3.org/TR/mediastream-recording): `FetchError: invalid json response body at https://api.w3.org/specifications/mediastream-recording/versions?embed=1 reason: Unexpected token < in JSON at position 0 FetchError: invalid json response body at https://api.w3.org/specifications/mediastream-recording/versions?embed=1 reason: Unexpected token < in JSON at position 0
...
- `WorkerType` used in [Service Workers 1](https://www.w3.org/TR/2017/WD-service-workers-1-20171102/), [Web App Manifest](https://www.w3.org/TR/2018/WD-appmanifest-20180828/)
...
- [Background Fetch](https://wicg.github.io/background-fetch/) uses `ImageResource` but does not reference [Web App Manifest](https://www.w3.org/TR/2018/WD-appmanifest-20180828/)
...
=> 585 missing references for links found in 138 specifications
...
- [Web App Manifest](https://www.w3.org/TR/2018/WD-appmanifest-20180828/) links to [`https://w3c.github.io/ServiceWorker/`](https://w3c.github.io/ServiceWorker/) but related reference "SERVICE-WORKERS-1" uses URL [`https://www.w3.org/TR/service-workers-1/`](https://www.w3.org/TR/service-workers-1/)
- [Web Audio API](https://www.w3.org/TR/2018/WD-webaudio-20180619/) links to:
...
=> 279 inconsistent references for links found in 133 specifications
