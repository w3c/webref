...
- `DOMPoint` used in [SVG Markers](http://www.w3.org/TR/2015/WD-svg-markers-20150409/)
...
- `DOMRectReadOnly` used in [Accelerated Shape Detection in Images](https://wicg.github.io/shape-detection-api/), [Resize Observer 1](https://wicg.github.io/ResizeObserver/)
...
- `HTMLImageElement` used in [HTML Canvas 2D Context](http://www.w3.org/TR/2015/REC-2dcontext-20151119/), [WebGL Specification](https://www.khronos.org/registry/webgl/specs/latest/1.0/)
...
- `Screen` used in [Media Capabilities](https://wicg.github.io/media-capabilities/), [The Screen Orientation API](https://www.w3.org/TR/2018/WD-screen-orientation-20180706/)
...
=> 58 missing references for IDL definitions found in 28 specifications
...
=> 543 missing references for links found in 138 specifications
...
=> 260 inconsistent references for links found in 135 specifications
