...
- `WorkerType` used in [Service Workers 1](https://www.w3.org/TR/2017/WD-service-workers-1-20171102/), [Web App Manifest](https://www.w3.org/TR/2018/WD-appmanifest-20180524/)
...
- `Worklet` defined in [CSS Painting API Level 1](https://www.w3.org/TR/2018/WD-css-paint-api-1-20180410/) and [Worklets Level 1](http://www.w3.org/TR/2016/WD-worklets-1-20160607/)
...
- [Console Standard](https://console.spec.whatwg.org/) uses:
    ...
    * `Worklet` but does not reference [CSS Painting API Level 1](https://www.w3.org/TR/2018/WD-css-paint-api-1-20180410/) or [Worklets Level 1](http://www.w3.org/TR/2016/WD-worklets-1-20160607/)
...
- [WebAssembly JavaScript Interface](https://www.w3.org/TR/2018/WD-wasm-js-api-1-20180215/) uses `Worklet` but does not reference [CSS Painting API Level 1](https://www.w3.org/TR/2018/WD-css-paint-api-1-20180410/) or [Worklets Level 1](http://www.w3.org/TR/2016/WD-worklets-1-20160607/)
...
- [Selection API](https://www.w3.org/TR/2018/WD-selection-api-20180402/) links to [`https://www.w3.org/TR/2000/REC-DOM-Level-2-Traversal-Range-20001113/`](https://www.w3.org/TR/2000/REC-DOM-Level-2-Traversal-Range-20001113/) but does not list it in its references
...
=> 267 missing references for links found in 75 specifications
...
- [Selection API](https://www.w3.org/TR/2018/WD-selection-api-20180402/) links to:
...
- [Web App Manifest](https://www.w3.org/TR/2018/WD-appmanifest-20180524/) links to [`https://w3c.github.io/ServiceWorker/`](https://w3c.github.io/ServiceWorker/) but related reference "SERVICE-WORKERS-1" uses URL [`https://www.w3.org/TR/service-workers-1/`](https://www.w3.org/TR/service-workers-1/)
