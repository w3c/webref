...
- `SharedWorker` used in [File API](https://www.w3.org/TR/2017/WD-FileAPI-20171026/), [XMLHttpRequest Standard](https://xhr.spec.whatwg.org/)
...
- `WorkerGlobalScope` used in [Service Workers 1](https://www.w3.org/TR/2017/WD-service-workers-1-20171102/), [WebRTC 1.0: Real-time Communication Between Browsers](https://www.w3.org/TR/2017/CR-webrtc-20171102/)
- `WorkerNavigator` used in [Permissions](https://www.w3.org/TR/2017/WD-permissions-20170925/), [Service Workers 1](https://www.w3.org/TR/2017/WD-service-workers-1-20171102/)
...
- [Encoding](https://www.w3.org/TR/2017/CR-encoding-20170413/) uses `Worker` but does not reference [Service Workers 1](https://www.w3.org/TR/2017/WD-service-workers-1-20171102/)
...
- [User Timing Level 2](https://www.w3.org/TR/2018/WD-user-timing-2-20180222/) uses `Worker` but does not reference [Service Workers 1](https://www.w3.org/TR/2017/WD-service-workers-1-20171102/)
...
- [WebAssembly JavaScript Interface](https://webassembly.github.io/spec/js-api/index.html) uses:
    * `Worker` but does not reference [Service Workers 1](https://www.w3.org/TR/2017/WD-service-workers-1-20171102/)
    * `Worklet` but does not reference [CSS Painting API Level 1](http://www.w3.org/TR/2016/WD-css-paint-api-1-20160607/) or [Worklets Level 1](http://www.w3.org/TR/2016/WD-worklets-1-20160607/)
...
=> 51 missing references for IDL definitions found in 27 specifications
...
=> 164 missing references for links found in 54 specifications
...
=> 158 inconsistent references for links found in 59 specifications
