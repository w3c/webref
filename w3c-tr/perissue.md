...
- [Payment Request API](https://www.w3.org/TR/payment-request/): `Error: Crawl exited without sending result Error: Crawl exited without sending result
    at ChildProcess.child.once.code (/home/dom/github.com/reffy/src/cli/crawl-specs.js:345:33)
    at Object.onceWrapper (events.js:317:30)
    at emitTwo (events.js:126:13)
    at ChildProcess.emit (events.js:214:7)
...
- `AddressErrors` used in [Payment Method: Basic Card](https://www.w3.org/TR/2018/WD-payment-method-basic-card-20181121/)
...
- `PaymentAddress` used in [Payment Method: Basic Card](https://www.w3.org/TR/2018/WD-payment-method-basic-card-20181121/)
- `PaymentCurrencyAmount` used in [Payment Handler API](https://www.w3.org/TR/2018/WD-payment-handler-20180108/)
- `PaymentDetailsModifier` used in [Payment Handler API](https://www.w3.org/TR/2018/WD-payment-handler-20180108/)
- `PaymentMethodData` used in [Payment Handler API](https://www.w3.org/TR/2018/WD-payment-handler-20180108/)
...
- `WorkerType` used in [Service Workers 1](https://www.w3.org/TR/2017/WD-service-workers-1-20171102/), [Web App Manifest](https://www.w3.org/TR/2018/WD-appmanifest-20181207/)
...
- [Background Fetch](https://wicg.github.io/background-fetch/) uses `ImageResource` but does not reference [Web App Manifest](https://www.w3.org/TR/2018/WD-appmanifest-20181207/)
...
- [Web Animations](https://www.w3.org/TR/2018/WD-web-animations-1-20181011/) links to:
    * [`https://w3c.github.io/hr-time/`](https://w3c.github.io/hr-time/) but related reference "HR-TIME-2" uses URL [`https://www.w3.org/TR/hr-time-2/`](https://www.w3.org/TR/hr-time-2/)
    * [`https://www.w3.org/TR/css3-values/`](https://www.w3.org/TR/css3-values/) but related reference "CSS-VALUES-3" uses URL [`https://www.w3.org/TR/css-values-3/`](https://www.w3.org/TR/css-values-3/)
- [Web App Manifest](https://www.w3.org/TR/2018/WD-appmanifest-20181207/) links to [`https://w3c.github.io/ServiceWorker/`](https://w3c.github.io/ServiceWorker/) but related reference "SERVICE-WORKERS-1" uses URL [`https://www.w3.org/TR/service-workers-1/`](https://www.w3.org/TR/service-workers-1/)
...
=> 266 inconsistent references for links found in 133 specifications
