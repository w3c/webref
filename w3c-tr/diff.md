% Diff between report from "January 09, 2018" and reference report from "December 26, 2017"
% Reffy
% January 09, 2018
...
- Crawled version: [Latest published version](http://www.w3.org/TR/2011/REC-css3-selectors-20110929/)
- Repository: [GitHub w3c/csswg-drafts](https://github.com/w3c/csswg-drafts)
- No WebIDL definitions found: *INS* false / *DEL* true
...
- Invalid WebIDL content found: *INS* true / *DEL* false
- Obsolete WebIDL constructs found: *DEL* false
- Unknown WebIDL names used: *DEL* HTMLCanvasElement, HTMLImageElement, HTMLVideoElement, ImageBitmap
