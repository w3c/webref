...
- Unknown WebIDL names used: *DEL* DOMRectReadOnly, Point2D, Worker
...
- Unknown WebIDL names used: *DEL* CacheQueryOptions, ExtendableEvent, ExtendableEventInit, ImageResource, ServiceWorker, ServiceWorkerGlobalScope, ServiceWorkerRegistration, Worker
...
- Unknown WebIDL names used: *DEL* ExtendableEvent, ExtendableEventInit, ServiceWorker, ServiceWorkerGlobalScope
...
- Unknown WebIDL names used: *DEL* Animation, AnimationEffect, AnimationTimeline, ComputedEffectTiming, EffectTiming, WorkletGlobalScope
...
- Unknown WebIDL names used: *DEL* DOMRectReadOnly, PerformanceEntry
...
- Unknown WebIDL names used: *DEL* Blob, ReferrerPolicy, Worker
...
- Unknown WebIDL names used: *DEL* MediaKeySystemAccess, MediaKeysRequirement, Worker
- Missing references for WebIDL names: *INS* Worker
...
- Unknown WebIDL names used: *DEL* Blob, File, Worker
