% Diff between report from "August 25, 2018" and reference report from "August 24, 2018"
% Reffy
% August 25, 2018
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2016/WD-CSP3-20160913/)
...
- Unknown WebIDL names used: *INS* Event, EventInit
- Missing references for links: *INS* https://w3c.github.io/dom/
...
- Repository: [GitHub w3c/csswg-drafts](https://github.com/w3c/csswg-drafts)
- Unknown WebIDL names used: *INS* Document, Element, ProcessingInstruction
- Missing references for links: *INS* https://www.w3.org/TR/css-display-3/
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2017/WD-css-transitions-1-20171130/)
...
- Repository: [GitHub w3c/csswg-drafts](https://github.com/w3c/csswg-drafts)
- Unknown WebIDL names used: *INS* Document, Element, Event, EventInit, EventListener, EventTarget, Node, Range, Text
- Missing references for links: *INS* https://www.w3.org/TR/css-display-3/
...
- Unknown WebIDL names used: *INS* Document, DocumentFragment, Element, Node, Range
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2018/WD-gamepad-20180716/)
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2018/CR-payment-request-20180820/)
...
- Unknown WebIDL names used: *INS* Document, DocumentOrShadowRoot, Element, EventTarget


## Pointer Events

- URL: [https://www.w3.org/TR/pointerevents2/](https://www.w3.org/TR/pointerevents2/)
- Crawled version: [Latest published version](https://www.w3.org/TR/2018/CR-pointerevents2-20180522/)
...
- Unknown WebIDL names used: *INS* Document, Element, NodeList, ShadowRoot
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2018/WD-selection-api-20180612/)
...
- Unknown WebIDL names used: *INS* Document, Node, Range
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2018/WD-screen-orientation-20180706/)
...
- Unknown WebIDL names used: *INS* Document, EventTarget
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2018/WD-appmanifest-20180719/)
...
- Unknown WebIDL names used: *INS* Document, Event, EventTarget
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2018/CR-webrtc-20180621/)
...
- Unknown WebIDL names used: *INS* DocumentFragment
