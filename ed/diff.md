% Diff between report from "November 26, 2019" and reference report from "November 14, 2019"
% Reffy
% November 26, 2019
...
- Missing references for WebIDL names: *DEL* Window, DOMHighResTimeStamp, Navigator
...
- Missing references for WebIDL names: *DEL* Navigator, Window
...
- Missing references for WebIDL names: *DEL* ServiceWorker, Blob
...
- No WebIDL definitions found: *INS* true / *DEL* false
- Missing references for WebIDL names: *DEL* Window, Worker, DOMHighResTimeStamp
