% Diff between report from "July 11, 2020" and reference report from "July 11, 2020"
% Reffy
% July 11, 2020
...
- Spec title: *INS* CSS 2 / *DEL* 500 Internal Server Error
...
- Spec title: *INS* CSS Animations Level 1 / *DEL* 500 Internal Server Error
- No normative references found: *INS* false / *DEL* true
...
- Spec title: *INS* CSS Custom Properties for Cascading Variables Module Level 1 / *DEL* 500 Internal Server Error
- No normative references found: *INS* false / *DEL* true
- Missing references for links: *INS* https://www.w3.org/TR/css-cascade/, https://www.w3.org/TR/css-pseudo/, https://www.w3.org/TR/web-animations/
- Inconsistent references for links: *INS* https://www.w3.org/TR/css-values/
...
- Spec title: *INS* CSS Images Module Level 4 / *DEL* 500 Internal Server Error
- No normative references found: *INS* false / *DEL* true
...
- Spec is OK: *INS* true / *DEL* false
- Unknown WebIDL names used: *DEL* CSSStyleValue
...
- Spec title: *INS* CSS Speech Module Level 1 / *DEL* 500 Internal Server Error
- No normative references found: *INS* false / *DEL* true
...
- Spec title: *INS* CSS Syntax Module Level 3 / *DEL* 500 Internal Server Error
- No normative references found: *INS* false / *DEL* true
...
- Spec title: *INS* CSS Table Module Level 3 / *DEL* 500 Internal Server Error
- No normative references found: *INS* false / *DEL* true
...
- Spec title: *INS* CSS Text Module Level 3 / *DEL* 500 Internal Server Error
- No normative references found: *INS* false / *DEL* true
...
- Spec title: *INS* CSS Transforms Module Level 1 / *DEL* 500 Internal Server Error
- No normative references found: *INS* false / *DEL* true
...
- Spec title: *INS* CSS Transitions Level 2 / *DEL* 500 Internal Server Error
- No normative references found: *INS* false / *DEL* true
- Unknown WebIDL names used: *INS* CSSOMString
...
- Spec title: *INS* CSS Typed OM Level 1 / *DEL* 500 Internal Server Error
- No normative references found: *INS* false / *DEL* true
...
- Spec title: *INS* Filter Effects Module Level 1 / *DEL* 500 Internal Server Error
- No normative references found: *INS* false / *DEL* true
...
- Spec title: *INS* Geometry Interfaces Module Level 1 / *DEL* 500 Internal Server Error
- Spec is OK: *INS* true / *DEL* false
- No normative references found: *INS* false / *DEL* true
...
- Unknown WebIDL names used: *DEL* CSSKeywordish, CSSNumericValue
...
- Spec title: *INS* Selectors Level 4 / *DEL* 500 Internal Server Error
- No normative references found: *INS* false / *DEL* true
