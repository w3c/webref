...
The following network or parsing error occurred:
`FetchError: invalid json response body at https://api.w3.org/specifications/css-break-3/versions?embed=1 reason: Unexpected token < in JSON at position 0 FetchError: invalid json response body at https://api.w3.org/specifications/css-break-3/versions?embed=1 reason: Unexpected token < in JSON at position 0
    at /home/runner/work/reffy-reports/reffy-reports/reffy/node_modules/node-fetch/lib/index.js:272:32
    at process._tickCallback (internal/process/next_tick.js:68:7)`
...
The following network or parsing error occurred:
`FetchError: invalid json response body at https://api.w3.org/specifications/css-gcpm-3/versions?embed=1 reason: Unexpected token < in JSON at position 0 FetchError: invalid json response body at https://api.w3.org/specifications/css-gcpm-3/versions?embed=1 reason: Unexpected token < in JSON at position 0
    at /home/runner/work/reffy-reports/reffy-reports/reffy/node_modules/node-fetch/lib/index.js:272:32
    at process._tickCallback (internal/process/next_tick.js:68:7)`
...
The following network or parsing error occurred:
`FetchError: invalid json response body at https://api.w3.org/specifications/css-overflow-4/versions?embed=1 reason: Unexpected token < in JSON at position 0 FetchError: invalid json response body at https://api.w3.org/specifications/css-overflow-4/versions?embed=1 reason: Unexpected token < in JSON at position 0
    at /home/runner/work/reffy-reports/reffy-reports/reffy/node_modules/node-fetch/lib/index.js:272:32
    at process._tickCallback (internal/process/next_tick.js:68:7)`
...
## DOM Standard {data-spec=true data-anomaly=true data-unknownExposedNames=true data-missingLinkRef=true data-inconsistentRef=true}
...
## HTML Standard {data-spec=true data-anomaly=true data-unknownExposedNames=true data-unknownIdlNames=true data-missingWebIdlRef=true data-missingLinkRef=true}
...
The following network or parsing error occurred:
`FetchError: invalid json response body at https://api.w3.org/specifications/webaudio/versions?embed=1 reason: Unexpected token < in JSON at position 0 FetchError: invalid json response body at https://api.w3.org/specifications/webaudio/versions?embed=1 reason: Unexpected token < in JSON at position 0
    at /home/runner/work/reffy-reports/reffy-reports/reffy/node_modules/node-fetch/lib/index.js:272:32
    at process._tickCallback (internal/process/next_tick.js:68:7)`
