...
- Spec could not be rendered: *INS* TypeError: Cannot read property 'map' of undefined TypeError: Cannot read property 'map' of undefined
...
- Unknown WebIDL names used: *INS* DOMRectReadOnly, Point2D / *DEL* ImageBitmapSource, Window
...
- Unknown WebIDL names used: *INS* ImageResource / *DEL* EventHandler, Window
...
- Unknown WebIDL names used: *INS* Worklet / *DEL* Window
...
- Unknown WebIDL names used: *INS* Animatable, Animation, AnimationTimeline, KeyframeEffectOptions / *DEL* Window
...
- Unknown WebIDL names used: *INS* AudioWorklet, DOMHighResTimeStamp / *DEL* EventHandler, HTMLSlotElement, Window
...
- Unknown WebIDL names used: *INS* DOMHighResTimeStamp, DOMRectReadOnly, PerformanceEntry / *DEL* Window
...
- Unknown WebIDL names used: *INS* DOMHighResTimeStamp, Performance, PerformanceEntry / *DEL* Window
...
- Unknown WebIDL names used: *INS* Blob, ReferrerPolicy / *DEL* Window, WindowOrWorkerGlobalScope
...
- Unknown WebIDL names used: *INS* File / *DEL* DataTransferItem, HTMLInputElement
...
- Unknown WebIDL names used: *INS* DOMHighResTimeStamp, Sensor, SensorOptions / *DEL* DedicatedWorker, Window
...
- Unknown WebIDL names used: *INS* UIEvent, UIEventInit / *DEL* Window
...
- Unknown WebIDL names used: *INS* DOMHighResTimeStamp, PerformanceEntry / *DEL* Window
...
- Unknown WebIDL names used: *INS* MediaKeySystemAccess, MediaKeysRequirement / *DEL* EventHandler, Navigator, Window, WorkerNavigator
...
- Unknown WebIDL names used: *INS* DOMHighResTimeStamp / *DEL* HTMLVideoElement, Window
...
- Unknown WebIDL names used: *INS* VibratePattern / *DEL* EventHandler, Window
...
- Unknown WebIDL names used: *INS* DOMRectReadOnly / *DEL* Window
...
- Unknown WebIDL names used: *INS* AnimationTimeline, FillMode / *DEL* Window
...
- Unknown WebIDL names used: *INS* VisibilityState / *DEL* EventHandler, MessagePort, Navigator, PostMessageOptions, Window, WindowOrWorkerGlobalScope, WorkerGlobalScope, WorkerNavigator, WorkerType
...
- Unknown WebIDL names used: *INS* PermissionDescriptor, PermissionStatus / *DEL* EventHandler, Navigator, Window
...
- Unknown WebIDL names used: *INS* PermissionDescriptor, PermissionStatus / *DEL* DedicatedWorker, EventHandler, Navigator, SharedWorker, Window, WorkerNavigator
- Missing references for links: *INS* https://w3c.github.io/permissions/
...
- Unknown WebIDL names used: *INS* Blob, File / *DEL* DedicatedWorker, EventHandler, SharedWorker, Window
