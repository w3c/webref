...
- [CSS Parser API](https://wicg.github.io/CSS-Parser-API/): `Error: Evaluation failed: TypeError: Cannot read property 'getTitle' of undefined
  ...
  -- ASYNC --
    ...
    at process._tickCallback (internal/process/next_tick.js:68:7)`
- [Input Device Capabilities](https://wicg.github.io/InputDeviceCapabilities/): `Error: Evaluation failed: TypeError: Cannot read property 'getTitle' of undefined
    at __puppeteer_evaluation_script__:4:37 Error: Evaluation failed: TypeError: Cannot read property 'getTitle' of undefined
    at __puppeteer_evaluation_script__:4:37
    at ExecutionContext._evaluateInternal (/home/runner/work/reffy-reports/reffy-reports/reffy/node_modules/puppeteer/lib/ExecutionContext.js:93:19)
    at process._tickCallback (internal/process/next_tick.js:68:7)
...
- [MathML Core](https://mathml-refresh.github.io/mathml-core/): `Error: Navigation failed because browser has disconnected! Error: Navigation failed because browser has disconnected!
  ...
  -- ASYNC --
    ...
    at process._tickCallback (internal/process/next_tick.js:68:7)`
- [SVG Strokes](https://svgwg.org/specs/strokes/): `[object Object]`
- [Text Fragments](https://wicg.github.io/ScrollToTextFragment/): `Error: Evaluation failed: TypeError: Cannot read property 'getTitle' of undefined
    at __puppeteer_evaluation_script__:4:37 Error: Evaluation failed: TypeError: Cannot read property 'getTitle' of undefined
    at __puppeteer_evaluation_script__:4:37
    at ExecutionContext._evaluateInternal (/home/runner/work/reffy-reports/reffy-reports/reffy/node_modules/puppeteer/lib/ExecutionContext.js:93:19)
    at process._tickCallback (internal/process/next_tick.js:68:7)
...
- `ReadableStream` used in [Compression Streams](https://wicg.github.io/compression/), [Encoding Standard](https://encoding.spec.whatwg.org/), [Fetch Standard](https://fetch.spec.whatwg.org/), [File API](https://w3c.github.io/FileAPI/), [Serial API](https://wicg.github.io/serial/), [WebTransport](https://wicg.github.io/web-transport/)
...
- `WritableStream` used in [Compression Streams](https://wicg.github.io/compression/), [Encoding Standard](https://encoding.spec.whatwg.org/), [Native File System](https://wicg.github.io/native-file-system/), [Serial API](https://wicg.github.io/serial/), [WebTransport](https://wicg.github.io/web-transport/)
...
- [Portals](https://wicg.github.io/portals/) uses `ServiceWorker` but does not reference [Service Workers Nightly](https://w3c.github.io/ServiceWorker/)
...
- [Web Background Synchronization](https://wicg.github.io/background-sync/spec/) uses:
    * `ServiceWorkerRegistration` but does not reference [Service Workers Nightly](https://w3c.github.io/ServiceWorker/)
    * `ServiceWorkerGlobalScope` but does not reference [Service Workers Nightly](https://w3c.github.io/ServiceWorker/)
    * `ExtendableEvent` but does not reference [Service Workers Nightly](https://w3c.github.io/ServiceWorker/)
    * `ExtendableEventInit` but does not reference [Service Workers Nightly](https://w3c.github.io/ServiceWorker/)
...
=> 43 missing references for IDL definitions found in 18 specifications
...
- [CSS Backgrounds and Borders Module Level 4](https://drafts.csswg.org/css4-background/) links to:
    * [`https://www.w3.org/TR/css3-background/`](https://www.w3.org/TR/css3-background/) but does not list it in its references
    * [`https://www.w3.org/TR/css-values/`](https://www.w3.org/TR/css-values/) but does not list it in its references
    * [`https://www.w3.org/TR/css-cascade/`](https://www.w3.org/TR/css-cascade/) but does not list it in its references
    * [`https://www.w3.org/TR/web-animations/`](https://www.w3.org/TR/web-animations/) but does not list it in its references
...
- [Permissions Policy](https://w3c.github.io/webappsec-feature-policy/) links to [`https://w3c.github.io/reporting/`](https://w3c.github.io/reporting/) but does not list it in its references
...
=> 568 missing references for links found in 157 specifications
...
- [Permissions](https://w3c.github.io/permissions/) links to:
    * [`https://w3c.github.io/webappsec-secure-contexts/`](https://w3c.github.io/webappsec-secure-contexts/) but related reference "SECURE-CONTEXTS" uses URL [`https://www.w3.org/TR/secure-contexts/`](https://www.w3.org/TR/secure-contexts/)
    * [`https://w3c.github.io/mediacapture-main/`](https://w3c.github.io/mediacapture-main/) but related reference "GETUSERMEDIA" uses URL [`https://www.w3.org/TR/mediacapture-streams/`](https://www.w3.org/TR/mediacapture-streams/)
    * [`https://w3c.github.io/webdriver/`](https://w3c.github.io/webdriver/) but related reference "WebDriver" uses URL [`https://www.w3.org/TR/webdriver1/`](https://www.w3.org/TR/webdriver1/)
...
- [Web Locks API](https://wicg.github.io/web-locks/) links to [`https://w3c.github.io/IndexedDB/`](https://w3c.github.io/IndexedDB/) but related reference "IndexedDB-2" uses URL [`https://www.w3.org/TR/IndexedDB-2/`](https://www.w3.org/TR/IndexedDB-2/)
...
=> 299 inconsistent references for links found in 160 specifications
