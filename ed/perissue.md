...
- [Web Share API](https://w3c.github.io/web-share/) uses `Navigator` but does not reference [HTML Standard](https://html.spec.whatwg.org/)
...
=> 70 missing references for IDL definitions found in 33 specifications
...
=> 378 missing references for links found in 133 specifications
