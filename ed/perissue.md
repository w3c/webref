...
- `WindowOrWorkerGlobalScope` used in [Fetch Standard](https://fetch.spec.whatwg.org/), [High Resolution Time](https://w3c.github.io/hr-time/), [Indexed Database API 3.0](https://w3c.github.io/IndexedDB/), [Secure Contexts](https://w3c.github.io/webappsec-secure-contexts/), [Service Workers Nightly](https://w3c.github.io/ServiceWorker/), [Web Cryptography API](http://w3c.github.io/webcrypto/)
...
- [Priority Hints](https://wicg.github.io/priority-hints/) links to:
...
=> 393 missing references for links found in 136 specifications
...
=> 216 inconsistent references for links found in 106 specifications
