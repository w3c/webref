...
- `HTMLBodyElement` used in [Compatibility Standard](https://compat.spec.whatwg.org/), [Compatibility Standard](https://compat.spec.whatwg.org/), [Compatibility Standard](https://compat.spec.whatwg.org/), [Compatibility Standard](https://compat.spec.whatwg.org/)
...
- [Identifiers for WebRTC's Statistics API](https://w3c.github.io/webrtc-stats/) uses `RTCPriorityType` but does not reference [WebRTC DSCP Control API](https://w3c.github.io/webrtc-dscp-exp/)
...
- [Identifiers for WebRTC's Statistics API](https://w3c.github.io/webrtc-stats/) links to [`https://w3c.github.io/webrtc-pc/`](https://w3c.github.io/webrtc-pc/) but does not list it in its references
...
=> 362 missing references for links found in 126 specifications
