...
- `WindowProxy` used in [HTML 5.3](https://w3c.github.io/html/), [HTML5 Web Messaging](http://www.w3.org/TR/2015/REC-webmessaging-20150519/), [Touch Events - Level 2](https://w3c.github.io/touch-events/)
...
- [Encoding Standard](https://encoding.spec.whatwg.org/) uses:
    * `Window` but does not reference [HTML 5.3](https://w3c.github.io/html/)
    * `Worker` but does not reference [Service Workers 1](https://w3c.github.io/ServiceWorker/v1/) or [Web Workers](https://html.spec.whatwg.org/multipage/workers.html)
- [Gamepad](https://w3c.github.io/gamepad/) uses `Navigator` but does not reference [HTML 5.3](https://w3c.github.io/html/)
...
- [HTML 5.3](https://w3c.github.io/html/) uses `WebGLRenderingContext` but does not reference [WebGL Specification](https://www.khronos.org/registry/webgl/specs/latest/1.0/)
...
- [Pointer Lock 2.0](https://w3c.github.io/pointerlock/) uses `EventHandler` but does not reference [HTML 5.3](https://w3c.github.io/html/)
...
- [HTML 5.3](https://w3c.github.io/html/) links to:
    ...
    * [`https://www.w3.org/TR/2017/WD-html53-20171214/%3EHTML%205.3%20First%20Public%20Working%20Draft%3C/a%3E%20%20%3Cdl%3E%20%20%20%20%3Cdt%3E%3Ca%20href=`](https://www.w3.org/TR/2017/WD-html53-20171214/%3EHTML%205.3%20First%20Public%20Working%20Draft%3C/a%3E%20%20%3Cdl%3E%20%20%20%20%3Cdt%3E%3Ca%20href=) but does not list it in its references
    * [`https://www.w3.org/TR/2017/WD-html53-20171214/%3EHTML%205.3%20First%20Public%20Working%20Draft%3C/a%3E%20and%20%20%3Ca%20href=`](https://www.w3.org/TR/2017/WD-html53-20171214/%3EHTML%205.3%20First%20Public%20Working%20Draft%3C/a%3E%20and%20%20%3Ca%20href=) but does not list it in its references
