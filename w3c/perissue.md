...
- [Web MIDI API](http://webaudio.github.io/web-midi-api/) uses `DOMHighResTimeStamp` but does not reference [High Resolution Time Level 2](https://w3c.github.io/hr-time/)
