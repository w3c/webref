% Diff between report from "January 23, 2018" and reference report from "January 22, 2018"
% Reffy
% January 23, 2018
...
- Missing references for links: *DEL* https://w3c.github.io/webappsec-secure-contexts/, https://w3c.github.io/webauthn/
- Inconsistent references for links: *INS* https://w3c.github.io/webappsec-secure-contexts/, https://w3c.github.io/webauthn/
...
- Unknown WebIDL names used: *DEL* Worker
...
- Unknown WebIDL names used: *DEL* URL, Worker
- Missing references for WebIDL names: *INS* Worker
...
- Missing references for links: *DEL* https://www.w3.org/TR/service-workers/
...
- Invalid WebIDL content found: *INS* false / *DEL* true
- Obsolete WebIDL constructs found: *INS* false
- Unknown WebIDL names used: *INS* PerformanceEntryList, PerformanceObserver, Window
- Missing references for WebIDL names: *INS* Worker
...
- Unknown WebIDL names used: *DEL* Worker
- Missing references for WebIDL names: *INS* Worker
- Missing references for links: *DEL* https://w3c.github.io/webappsec-secure-contexts/, https://w3c.github.io/webdriver/webdriver-spec.html
- Inconsistent references for links: *INS* https://w3c.github.io/webappsec-secure-contexts/, https://w3c.github.io/webdriver/webdriver-spec.html
...
- Unknown WebIDL names used: *DEL* ExtendableEvent, ExtendableEventInit, ServiceWorker, ServiceWorkerGlobalScope, ServiceWorkerRegistration, Worker
- Missing references for links: *DEL* https://www.w3.org/TR/service-workers/
- Inconsistent references for links: *INS* https://www.w3.org/TR/service-workers/
...
- Unknown WebIDL names used: *DEL* Selection
...
- Invalid WebIDL content found: *INS* false / *DEL* true
- Obsolete WebIDL constructs found: *INS* false
- Unknown WebIDL names used: *INS* EventHandler, PromptResponseObject, Window
- WebIDL names also defined elsewhere: *INS* ServiceWorkerRegistration
- Missing references for links: *DEL* https://w3c.github.io/ServiceWorker/, https://w3c.github.io/screen-orientation/, https://w3c.github.io/webappsec-secure-contexts/
