...
- Unknown WebIDL names used: *DEL* CacheQueryOptions, EventHandler, ExtendableEvent, ExtendableEventInit, ImageResource, ServiceWorker, ServiceWorkerGlobalScope, ServiceWorkerRegistration, Window, Worker
...
- Unknown WebIDL names used: *DEL* EventHandler, ExtendableEvent, ExtendableEventInit, ServiceWorker, ServiceWorkerGlobalScope, Window
...
- Unknown WebIDL names used: *DEL* Animation, AnimationEffect, AnimationTimeline, CSS, ComputedEffectTiming, EffectTiming, Window, WorkletGlobalScope
...
- Unknown WebIDL names used: *DEL* Animation, Window
...
- Unknown WebIDL names used: *DEL* DOMHighResTimeStamp, DOMRectReadOnly, PerformanceEntry, Window
...
- Unknown WebIDL names used: *DEL* Blob, ReferrerPolicy, Window, WindowOrWorkerGlobalScope, Worker
...
- Unknown WebIDL names used: *DEL* DOMHighResTimeStamp, DedicatedWorker, Sensor, SensorOptions, Window
...
- Unknown WebIDL names used: *DEL* UIEvent, UIEventInit, Window
...
- Unknown WebIDL names used: *DEL* DOMHighResTimeStamp, PerformanceEntry, Window
...
- Unknown WebIDL names used: *DEL* DOMHighResTimeStamp, HTMLVideoElement, Window
...
- Unknown WebIDL names used: *DEL* EventHandler, Window, Worker
...
- Unknown WebIDL names used: *DEL* DOMRectReadOnly, Window
...
- Unknown WebIDL names used: *DEL* AnimationTimeline, FillMode, Window
...
- Unknown WebIDL names used: *DEL* EventHandler, Navigator, PermissionDescriptor, PermissionStatus, Window
...
- Repository: [GitHub KhronosGroup/WebGL](https://github.com/KhronosGroup/WebGL)
- Unknown WebIDL names used: *DEL* HTMLCanvasElement, HTMLImageElement, HTMLVideoElement, ImageBitmap, ImageData, OffscreenCanvas, Window, Worker
...
- Unknown WebIDL names used: *DEL* DedicatedWorker, EventHandler, Navigator, PermissionDescriptor, PermissionStatus, SharedWorker, Window, WorkerNavigator
- Missing references for links: *DEL* https://w3c.github.io/permissions/
- Inconsistent references for links: *INS* https://w3c.github.io/permissions/
...
- Unknown WebIDL names used: *DEL* Blob, DedicatedWorker, EventHandler, File, HTMLFormElement, SharedWorker, Window, Worker
