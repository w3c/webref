...
- Unknown WebIDL names used: `AbortSignal`, `FormData`, `HTMLFormElement`, `Navigator`, `URLSearchParams`, `Window`
- Missing references for links: 
...
- Unknown WebIDL names used: `EventHandler`, `HTMLElement`, `HTMLImageElement`, `MouseEvent`, `MouseEventInit`, `Window`
...
- Unknown WebIDL names used: `DedicatedWorker`, `EventHandler`, `SharedWorker`, `URL`, `Window`
- Missing references for WebIDL names: 
     * `Worker` defined in [Service Workers 1](https://w3c.github.io/ServiceWorker/v1/)
...
- Unknown WebIDL names used: `HTMLCanvasElement`, `HTMLImageElement`, `HTMLVideoElement`, `MouseEvent`, `MouseEventInit`
- Missing references for WebIDL names: 
...
## Input Events Level 1 {data-spec=true data-anomaly=true data-noRefToWebIDL=true data-unknownIdlNames=true data-missingLinkRef=true}
...
- Spec uses WebIDL but does not reference it normatively
- Unknown WebIDL names used: `DataTransfer`, `InputEvent`, `InputEventInit`, `StaticRange`
- Missing references for links: 
     * [`https://w3c.github.io/uievents/`](https://w3c.github.io/uievents/)
...
- Unknown WebIDL names used: `AudioTrack`, `AudioTrackList`, `EventHandler`, `TextTrack`, `TextTrackList`, `TimeRanges`, `URL`, `VideoTrack`, `VideoTrackList`
- Missing references for WebIDL names: 
     * `EventTarget` defined in [W3C DOM 4.1](https://w3c.github.io/dom/)
...
- Spec uses WebIDL but does not reference it normatively
- Unknown WebIDL names used: `EventHandler`, `GlobalEventHandlers`, `MouseEvent`, `MouseEventInit`, `Navigator`, `Window`
...
- Unknown WebIDL names used: `EventHandler`, `MouseEvent`, `MouseEventInit`
...
## Progress Events {data-spec=true data-anomaly=true data-missingLinkRef=true}
...
## Shadow DOM {data-spec=true data-anomaly=true data-noRefToWebIDL=true data-unknownIdlNames=true data-redefinedIdlNames=true data-missingWebIdlRef=true data-missingLinkRef=true}
...
- Unknown WebIDL names used: `EventHandler`, `EventModifierInit`, `GlobalEventHandlers`, `UIEvent`, `Window`, `WindowProxy`
- Missing references for links: 
