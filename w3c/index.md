...
## https://drafts.csswg.org/css-scroll-anchoring-1/ {data-spec=true data-error=true}
...
- Crawled version: [Initial URL](https://w3c.github.io/editing/contentEditable.html) (Mon Feb 25 2019)
- Shortname: no shortname
...
## Event Timing API {data-spec=true data-anomaly=true data-unknownIdlNames=true data-missingLinkRef=true}
...
- Crawled version: [Initial URL](https://w3c.github.io/webappsec-feature-policy/) (22 February 2019)
- Shortname: no shortname
...
- Unknown WebIDL names used: `AbortSignal`, `Blob`, `ReadableStream`, `ReferrerPolicy`, `Window`, `WindowOrWorkerGlobalScope`, `Worker`
...
- Unknown WebIDL names used: `AbortSignal`, `DOMHighResTimeStamp`, `Sensor`, `SensorOptions`, `Window`
...
## HTML Canvas 2D Context {data-spec=true data-anomaly=true data-unknownIdlNames=true data-inconsistentRef=true data-noEdDraft=true}
...
- Unknown WebIDL names used: `Element`, `HTMLCanvasElement`, `HTMLImageElement`, `HTMLVideoElement`, `MouseEvent`, `MouseEventInit`
- Inconsistent references for links: 
...
- Crawled version: [Initial URL](https://wicg.github.io/InputDeviceCapabilities/) (Mon Feb 25 2019)
...
- Unknown WebIDL names used: `EventHandler`, `MediaKeySystemAccess`, `MediaKeysRequirement`, `Navigator`, `Screen`, `Window`, `Worker`, `WorkerNavigator`
- Missing references for links: 
...
- Crawled version: [Initial URL](https://wicg.github.io/mediasession/) (4 February 2019)
...
- Crawled version: [Initial URL](https://wicg.github.io/netinfo/) (Mon Feb 25 2019)
...
- Crawled version: [Initial URL](https://w3c.github.io/pointerevents/extension.html) (Mon Feb 25 2019)
- Shortname: no shortname
...
- Crawled version: [Initial URL](https://w3c.github.io/reporting/) (8 February 2019)
...
- Crawled version: [Initial URL](https://wicg.github.io/scroll-animations/) (22 February 2019)
...
## Web Authentication:An API for accessing Public Key CredentialsLevel 1 {data-spec=true data-error=true}
...
- Crawled version: [Initial URL](https://w3c.github.io/web-nfc/) (Mon Feb 25 2019)
...
- Crawled version: [Initial URL](https://wicg.github.io/web-share/) (Mon Feb 25 2019)
...
- Crawled version: [Initial URL](https://www.khronos.org/registry/webgl/specs/latest/2.0/) (Mon Feb 25 2019)
...
- Crawled version: [Initial URL](https://www.khronos.org/registry/webgl/specs/latest/1.0/) (Mon Feb 25 2019)
- Repository: [GitHub KhronosGroup/WebGL](https://github.com/KhronosGroup/WebGL)
- Shortname: no shortname

### Potential issue(s) {.anomalies}

- Unknown WebIDL names used: `Event`, `EventInit`, `HTMLCanvasElement`, `HTMLImageElement`, `HTMLVideoElement`, `ImageBitmap`, `OffscreenCanvas`, `Window`, `Worker`
...
- Crawled version: [Initial URL](https://wicg.github.io/webusb/) (24 February 2019)
- Repository: [GitHub wicg/webusb](https://github.com/wicg/webusb)
- Shortname: no shortname

### Potential issue(s) {.anomalies}

- Unknown WebIDL names used: `DedicatedWorker`, `Event`, `EventHandler`, `EventInit`, `EventTarget`, `Navigator`, `PermissionDescriptor`, `PermissionStatus`, `SharedWorker`, `Window`, `WorkerNavigator`
- Missing references for links: 
     * [`https://w3c.github.io/permissions/`](https://w3c.github.io/permissions/)
...
- Crawled version: [Initial URL](https://immersive-web.github.io/webxr/) (22 February 2019)
...
- Unknown WebIDL names used: `Blob`, `DedicatedWorker`, `Document`, `Event`, `EventHandler`, `EventInit`, `EventTarget`, `File`, `HTMLFormElement`, `SharedWorker`, `Window`, `Worker`
- Missing references for links: 
