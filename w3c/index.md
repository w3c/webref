...
## Input Events Level 1 {data-spec=true data-anomaly=true data-unknownIdlNames=true data-missingWebIdlRef=true data-inconsistentRef=true}
...
- Unknown WebIDL names used: `AbortSignal`, `Dictionary`, `EventHandler`, `Window`
...
- Crawled version: [Editor's Draft](https://html.spec.whatwg.org/multipage/workers.html) (24 January 2019)
...
- No normative references found
- Spec uses WebIDL but does not reference it normatively
- Unknown WebIDL names used: `EventHandler`, `OnErrorEventHandler`, `PostMessageOptions`, `Window`
- WebIDL names also defined elsewhere: 
