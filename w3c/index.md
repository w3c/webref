...
- Unknown WebIDL names used: `DataTransfer`, `Navigator`, `PermissionDescriptor`, `Window`
- Missing references for links: 
...
## Media Capture from DOM Elements {data-spec=true data-anomaly=true data-unknownIdlNames=true data-missingLinkRef=true}
...
## Navigation Timing Level 2 {data-spec=true data-anomaly=true data-unknownIdlNames=true data-missingWebIdlRef=true}
...
- Unknown WebIDL names used: `Window`
- Missing references for WebIDL names: 
     * `PerformanceResourceTiming` defined in [Resource Timing Level 2](https://w3c.github.io/resource-timing/)
     * `DOMHighResTimeStamp` defined in [High Resolution Time Level 2](https://w3c.github.io/hr-time/)
     * `Performance` defined in [High Resolution Time Level 2](https://w3c.github.io/hr-time/)
...
## Screen Capture {data-spec=true data-anomaly=true data-unknownIdlNames=true data-missingLinkRef=true data-inconsistentRef=true}
...
- Unknown WebIDL names used: `EventHandler`, `MediaStream`, `MediaStreamTrack`, `RTCError`, `Window`
- WebIDL names also defined elsewhere: 
