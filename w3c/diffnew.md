% Diff between report from "January 30, 2019" and reference report from "January 29, 2019"
% Reffy
% January 30, 2019
...
- Unknown WebIDL names used: *INS* DOMRectReadOnly, Point2D, Worker
...
- Unknown WebIDL names used: *INS* CacheQueryOptions, EventTarget, ExtendableEvent, ExtendableEventInit, ImageResource, ServiceWorker, ServiceWorkerGlobalScope, ServiceWorkerRegistration, Worker
...
- Unknown WebIDL names used: *INS* Worker, Worklet
...
- Unknown WebIDL names used: *INS* Event, EventInit, EventTarget, ExtendableEvent, ExtendableEventInit, ServiceWorker, ServiceWorkerGlobalScope
...
- Unknown WebIDL names used: *INS* Animation, AnimationEffect, AnimationTimeline, CSS, Worklet, WorkletGlobalScope
...
- Spec could not be rendered: *INS* TypeError: Cannot read property 'version-history' of undefined TypeError: Cannot read property 'version-history' of undefined
    ...
    at fetch.then.then.s (/home/dom/github.com/reffy/src/lib/util.js:311:34)
    at <anonymous>
    at process._tickCallback (internal/process/next_tick.js:189:7)
...
- Missing references for links: *INS* https://w3c.github.io/hr-time/, https://w3c.github.io/performance-timeline/, https://w3c.github.io/paint-timing/, https://w3c.github.io/pointerevents/, https://w3c.github.io/touch-events/
...
- Unknown WebIDL names used: *INS* Blob, ReferrerPolicy, Worker
...
- Unknown WebIDL names used: *INS* Document, DocumentOrShadowRoot, Element
...
- Unknown WebIDL names used: *INS* Element, MouseEvent, MouseEventInit
...
- Unknown WebIDL names used: *INS* MediaKeySystemAccess, MediaKeysRequirement, Screen, Worker, WorkerNavigator
...
- Unknown WebIDL names used: *INS* EventTarget, Worker
...
- Unknown WebIDL names used: *INS* Document, DocumentOrShadowRoot, Element, Event, EventInit, EventTarget
...
- Unknown WebIDL names used: *INS* AnimationTimeline, Element, FillMode
...
- Unknown WebIDL names used: *INS* Node, Range
...
- Unknown WebIDL names used: *INS* Worker
...
## Web Authentication:An API for accessing Public Key CredentialsLevel 1
...
- Spec title: *INS* Web Authentication:An API for accessing Public Key CredentialsLevel 1 / *DEL* Web Authentication: An API for accessing Public Key Credentials - Level 1
- Spec could not be rendered: *INS* TypeError: Cannot read property 'version-history' of undefined TypeError: Cannot read property 'version-history' of undefined
    at fetch.then.then.s (/home/dom/github.com/reffy/src/lib/util.js:312:34)
    at <anonymous>
    at process._tickCallback (internal/process/next_tick.js:189:7)
...
- Unknown WebIDL names used: *INS* ExtendableEvent, ExtendableEventInit, ServiceWorker, ServiceWorkerGlobalScope, ServiceWorkerRegistration, Worker
...
- Unknown WebIDL names used: *INS* Event, EventInit, EventTarget, PermissionDescriptor, PermissionStatus
...
- Unknown WebIDL names used: *INS* Document, Event, EventInit, EventTarget
...
- Repository: [GitHub KhronosGroup/WebGL](https://github.com/KhronosGroup/WebGL)
- Unknown WebIDL names used: *INS* Event, EventInit, Worker
...
- Unknown WebIDL names used: *INS* DedicatedWorker, Event, EventInit, EventTarget, PermissionDescriptor, PermissionStatus, SharedWorker, WorkerNavigator
- Missing references for links: *INS* https://w3c.github.io/permissions/
...
- Unknown WebIDL names used: *INS* DOMHighResTimeStamp, DOMPointInit, DOMPointReadOnly, Event, EventInit, EventTarget
...
- Unknown WebIDL names used: *INS* Blob, DedicatedWorker, Document, Event, EventInit, EventTarget, File, SharedWorker, Worker
