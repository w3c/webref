...
- Unknown WebIDL names used: *INS* DOMHighResTimeStamp
- Missing references for links: *INS* https://www.w3.org/TR/hr-time-2/
...
- Spec could not be rendered: *INS* FetchError: invalid json response body at https://api.w3.org/specifications/hr-time-3 reason: Unexpected token < in JSON at position 1 FetchError: invalid json response body at https://api.w3.org/specifications/hr-time-3 reason: Unexpected token < in JSON at position 1
...
- Spec could not be rendered: *INS* FetchError: invalid json response body at https://api.w3.org/specifications/preload reason: Unexpected token < in JSON at position 1 FetchError: invalid json response body at https://api.w3.org/specifications/preload reason: Unexpected token < in JSON at position 1
    at /home/dom/github.com/reffy/node_modules/node-fetch/lib/index.js:239:32
    at <anonymous>
    at process._tickCallback (internal/process/next_tick.js:189:7)
...
- Unknown WebIDL names used: *INS* DOMHighResTimeStamp, EventHandler, Navigator
