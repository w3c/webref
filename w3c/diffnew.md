% Diff between report from "July 13, 2018" and reference report from "July 13, 2018"
% Reffy
% July 13, 2018
...
- No CSS definitions found: *INS* false
- Unexpected WebIDL definitions found: *INS* false / *DEL* true
- Spec does not reference WebIDL normatively: *INS* false
...
- No WebIDL definitions found: *INS* true
- No CSS definitions found: *INS* false
- Spec does not reference WebIDL normatively: *INS* true
...
- Repository: [GitHub w3c/csswg-drafts](https://github.com/w3c/csswg-drafts)
- No WebIDL definitions found: *INS* false
- No CSS definitions found: *INS* true
- Unexpected WebIDL definitions found: *INS* false / *DEL* true
- Spec does not reference WebIDL normatively: *INS* false
...
- Crawled version: [Editor's Draft](https://drafts.csswg.org/css-flexbox/)
- Repository: [GitHub w3c/csswg-drafts](https://github.com/w3c/csswg-drafts)
- This specification was not in the reference crawl report.
...
- Crawled version: [Editor's Draft](http://drafts.csswg.org/css-overflow/)
- Repository: [GitHub w3c/csswg-drafts](https://github.com/w3c/csswg-drafts)
- This specification was not in the reference crawl report.
...
- Crawled version: [Editor's Draft](https://drafts.csswg.org/css-timing/)
- Repository: [GitHub w3c/csswg-drafts](https://github.com/w3c/csswg-drafts)
- This specification was not in the reference crawl report.
...
- URL: [https://drafts.csswg.org/css-values-4/](https://drafts.csswg.org/css-values-4/)
- Crawled version: [Initial URL](https://drafts.csswg.org/css-values-4/)
- This specification was not in the reference crawl report.
...
- Spec could not be rendered: *INS* Error: Crawl took too long Error: Crawl took too long
    at Timeout._ [as _onTimeout] (/home/dom/github.com/reffy/src/cli/crawl-specs.js:334:29)
    at ontimeout (timers.js:498:11)
    at tryOnTimeout (timers.js:323:5)
    at Timer.listOnTimeout (timers.js:290:5) / *DEL* Error: Crawl took too long Error: Crawl took too long
    at Timeout._ [as _onTimeout] (/home/dom/github.com/reffy/src/cli/crawl-specs.js:402:29)
    at ontimeout (timers.js:498:11)
    at tryOnTimeout (timers.js:323:5)
