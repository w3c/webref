% Diff between report from "September 09, 2019" and reference report from "September 08, 2019"
% Reffy
% September 09, 2019
...
- Unknown WebIDL names used: *INS* DOMRectReadOnly, ImageBitmapSource, Point2D, Window, Worker
...
- Unknown WebIDL names used: *INS* CacheQueryOptions, EventHandler, ExtendableEvent, ExtendableEventInit, ImageResource, ServiceWorker, ServiceWorkerGlobalScope, ServiceWorkerRegistration, Window, Worker
...
- Unknown WebIDL names used: *INS* Window, Worker
...
- Unknown WebIDL names used: *INS* EventHandler, ExtendableEvent, ExtendableEventInit, ServiceWorker, ServiceWorkerGlobalScope, Window
...
- Unknown WebIDL names used: *INS* Animation, AnimationEffect, AnimationTimeline, CSS, ComputedEffectTiming, EffectTiming, Window, WorkletGlobalScope
...
- Unknown WebIDL names used: *INS* Animation, Window
...
- Unknown WebIDL names used: *INS* DOMHighResTimeStamp, DOMRectReadOnly, PerformanceEntry, Window
...
- Unknown WebIDL names used: *INS* DOMHighResTimeStamp, Performance, PerformanceEntry, Window
...
- Unknown WebIDL names used: *INS* Blob, ReferrerPolicy, Window, WindowOrWorkerGlobalScope, Worker
...
- Unknown WebIDL names used: *INS* DataTransferItem, File, HTMLInputElement
...
- Unknown WebIDL names used: *INS* DOMHighResTimeStamp, DedicatedWorker, Sensor, SensorOptions, Window
...
- Spec title: *INS* HTML 5.2 / *DEL* HTML Standard
- Spec could not be rendered: *INS* TypeError: Cannot read property 'version-history' of undefined TypeError: Cannot read property 'version-history' of undefined
    at fetch.then.then.s (/home/dom/github.com/reffy/src/lib/util.js:316:34)
    at process._tickCallback (internal/process/next_tick.js:68:7)
...
- Unknown WebIDL names used: *INS* UIEvent, UIEventInit, Window
...
- Unknown WebIDL names used: *INS* DOMHighResTimeStamp, PerformanceEntry, Window
...
- Unknown WebIDL names used: *INS* EventHandler, MediaKeySystemAccess, MediaKeysRequirement, Navigator, Screen, Window, Worker, WorkerNavigator
...
- Unknown WebIDL names used: *INS* DOMHighResTimeStamp, HTMLVideoElement, Window
...
- Unknown WebIDL names used: *INS* EventHandler, Window, Worker
...
- Unknown WebIDL names used: *INS* DOMRectReadOnly, Window
...
- Unknown WebIDL names used: *INS* AnimationTimeline, FillMode, Window
...
- Unknown WebIDL names used: *INS* EventHandler, ExtendableEvent, ExtendableEventInit, ServiceWorker, ServiceWorkerGlobalScope, ServiceWorkerRegistration, Window, Worker
...
- Unknown WebIDL names used: *INS* EventHandler, Navigator, PermissionDescriptor, PermissionStatus, Window
...
- Repository: [GitHub KhronosGroup/WebGL](https://github.com/KhronosGroup/WebGL)
- Unknown WebIDL names used: *INS* HTMLCanvasElement, HTMLImageElement, HTMLVideoElement, ImageBitmap, ImageData, OffscreenCanvas, Window, Worker
...
- Unknown WebIDL names used: *INS* DedicatedWorker, EventHandler, Navigator, PermissionDescriptor, PermissionStatus, SharedWorker, Window, WorkerNavigator
- Missing references for links: *INS* https://w3c.github.io/permissions/
...
- Unknown WebIDL names used: *INS* Blob, DedicatedWorker, EventHandler, File, HTMLFormElement, SharedWorker, Window, Worker
