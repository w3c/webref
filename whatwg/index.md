...
## 404 Not Found {data-spec=true data-anomaly=true data-noNormativeRefs=true data-noRefToWebIDL=true data-noIdlContent=true}
...
## Navigation Timing Level 2 {data-spec=true data-anomaly=true data-hasObsoleteIdl=true data-unknownIdlNames=true data-inconsistentRef=true}
...
- Unknown WebIDL names used: `DOMStringMap`, `Type`
- Missing references for WebIDL names: 
...
- Unknown WebIDL names used: `EventHandler`, `GlobalEventHandlers`, `WindowProxy`
- Missing references for links: 
