...
- Crawled version: [Living Standard](https://html.spec.whatwg.org/) (5 February 2018)
- Shortname: no shortname

### Potential issue(s) {.anomalies}

- Unknown WebIDL names used: `AudioWorklet`, `DOMHighResTimeStamp`, `NavigatorID`, `SVGImageElement`, `SVGScriptElement`, `WindowProxy`
- WebIDL names also defined elsewhere: 
...
- Crawled version: [Editor's Draft](https://w3c.github.io/webrtc-pc/) (05 February 2018)
