% Diff between report from "November 22, 2017" and reference report from "November 21, 2017"
% Reffy
% November 22, 2017
...
- Spec could not be rendered: *DEL* FetchError: request to https://html.spec.whatwg.org/ failed, reason: socket hang up FetchError: request to https://html.spec.whatwg.org/ failed, reason: socket hang up
