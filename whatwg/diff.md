% Diff between report from "January 28, 2019" and reference report from "January 27, 2019"
% Reffy
% January 28, 2019
...
- Spec could not be rendered: *DEL* FetchError: invalid json response body at https://api.w3.org/specifications/css-grid-1/versions?embed=1 reason: Unexpected end of JSON input FetchError: invalid json response body at https://api.w3.org/specifications/css-grid-1/versions?embed=1 reason: Unexpected end of JSON input
...
- Unknown WebIDL names used: *DEL* FormData
