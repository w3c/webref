% Diff between report from "November 24, 2017" and reference report from "November 23, 2017"
% Reffy
% November 24, 2017
...
- Spec could not be rendered: *INS* FetchError: request to https://html.spec.whatwg.org/ failed, reason: socket hang up FetchError: request to https://html.spec.whatwg.org/ failed, reason: socket hang up
