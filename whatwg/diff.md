...
- Unknown WebIDL names used: *DEL* DOMTokenList, Document, DocumentFragment, Element, Event, EventInit, EventTarget, HTMLCollection, Node, NodeList, WindowProxy
...
- Unknown WebIDL names used: *INS* EventHandler, PerformanceEntry, Window
...
- Invalid WebIDL content found: *INS* true / *DEL* false
- Obsolete WebIDL constructs found: *DEL* false
- Unknown WebIDL names used: *DEL* Animatable, Animation, Document, Element, NodeList, ShadowRoot, Type
- Missing references for WebIDL names: *DEL* DOMRect, DOMMatrix, DOMPoint, DOMRectReadOnly, DOMPointReadOnly, DOMMatrixReadOnly
...
- WebIDL names also defined elsewhere: *DEL* ServiceWorkerRegistration, Worker
...
- Unknown WebIDL names used: *INS* PerformanceEntry, Window
- Missing references for WebIDL names: *INS* Worker
...
- Invalid WebIDL content found: *INS* true / *DEL* false
- Obsolete WebIDL constructs found: *DEL* false
- Unknown WebIDL names used: *DEL* Event
...
- Invalid WebIDL content found: *INS* true / *DEL* false
- Obsolete WebIDL constructs found: *DEL* false
- Unknown WebIDL names used: *DEL* AudioWorkletOptions, Event, EventInit, EventTarget
