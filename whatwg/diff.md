...
- Spec is OK: *INS* true / *DEL* false
- Unknown WebIDL names used: *DEL* Navigator, Window, WorkerNavigator
- Missing references for WebIDL names: *DEL* Worker
...
- Repository: [GitHub KhronosGroup/WebGL](https://github.com/KhronosGroup/WebGL)
- Unknown WebIDL names used: *DEL* HTMLCanvasElement, HTMLImageElement, HTMLVideoElement, ImageBitmap, ImageData, Window
- Missing references for WebIDL names: *DEL* Worker
