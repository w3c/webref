...
- Missing references for WebIDL names: *DEL* Worker, Point2D
...
- Missing references for WebIDL names: *DEL* Worker, ImageResource
...
- Unknown WebIDL names used: *INS* Animation / *DEL* Window
...
- Inconsistent references for links: *DEL* https://w3c.github.io/hr-time/, https://w3c.github.io/performance-timeline/, https://w3c.github.io/paint-timing/, https://w3c.github.io/pointerevents/, https://w3c.github.io/touch-events/
...
- Unknown WebIDL names used: *INS* DOMHighResTimeStamp, Sensor, SensorOptions / *DEL* Window
- WebIDL names also defined elsewhere: *DEL* GeolocationReadingValues
...
- Unknown WebIDL names used: *INS* MediaKeySystemAccess, MediaKeysRequirement, Screen / *DEL* EventHandler, Navigator, Window, WorkerNavigator
...
- Unknown WebIDL names used: *INS* VisibilityState / *DEL* EventHandler, MessagePort, Navigator, Window, WindowOrWorkerGlobalScope, WorkerGlobalScope, WorkerNavigator, WorkerType
...
- Unknown WebIDL names used: *INS* DOMHighResTimeStamp, DOMPointInit, DOMPointReadOnly / *DEL* EventHandler, HTMLCanvasElement, Navigator, Window
...
- Unknown WebIDL names used: *INS* Blob, File / *DEL* DedicatedWorker, EventHandler, HTMLFormElement, SharedWorker, Window
- Missing references for WebIDL names: *DEL* Worker
