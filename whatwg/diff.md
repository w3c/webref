...
- Crawled version: [Latest published version](http://www.w3.org/TR/css-scoping-1/)
...
- Repository: [GitHub KhronosGroup/WebGL](https://github.com/KhronosGroup/WebGL)
- Unknown WebIDL names used: *INS* HTMLCanvasElement, HTMLImageElement, HTMLVideoElement, ImageBitmap, ImageData, Window
- Missing references for WebIDL names: *INS* Worker
