% Diff between report from "July 15, 2018" and reference report from "July 14, 2018"
% Reffy
% July 15, 2018
...
- Repository: [GitHub w3c/csswg-drafts](https://github.com/w3c/csswg-drafts)
- Unknown WebIDL names used: *DEL* Document, Element, ProcessingInstruction
...
- Repository: [GitHub w3c/csswg-drafts](https://github.com/w3c/csswg-drafts)
- Unknown WebIDL names used: *DEL* Document, Element, Event, EventInit, EventListener, EventTarget, Node, Range, Text
...
- Unknown WebIDL names used: *DEL* DOMTokenList, Document, DocumentFragment, Element, Event, EventInit, EventTarget, HTMLCollection, Node, NodeList
...
- Missing references for WebIDL names: *DEL* StaticRange
...
- Unknown WebIDL names used: *DEL* Document, DocumentOrShadowRoot, Element, EventTarget
...
- Unknown WebIDL names used: *DEL* Document, Element, NodeList, ShadowRoot
...
- Unknown WebIDL names used: *DEL* Node, Range
...
- Unknown WebIDL names used: *DEL* Document, EventTarget
...
- Unknown WebIDL names used: *DEL* Document, Element, Event, EventInit, EventTarget
