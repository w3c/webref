% Diff between report from "July 02, 2018" and reference report from "July 02, 2018"
% Reffy
% July 02, 2018
...
- Missing references for links: *DEL* https://www.w3.org/TR/screen-orientation/
...
- Unknown WebIDL names used: *DEL* BodyInit
...
- Unknown WebIDL names used: *DEL* PermissionDescriptor
...
- Unknown WebIDL names used: *DEL* FormData, URLSearchParams
- Missing references for links: *DEL* https://w3c.github.io/webappsec-mixed-content/, https://w3c.github.io/webappsec-secure-contexts/, https://w3c.github.io/webauthn/
- Inconsistent references for links: *INS* https://w3c.github.io/webappsec-mixed-content/, https://w3c.github.io/webappsec-secure-contexts/, https://w3c.github.io/webauthn/
...
- Unknown WebIDL names used: *DEL* AudioWorklet
...
- Spec is OK: *INS* true / *DEL* false
- Unknown WebIDL names used: *DEL* URL
...
- Missing references for links: *DEL* https://www.w3.org/TR/page-visibility-2/, https://www.w3.org/TR/permissions/
- Inconsistent references for links: *INS* https://www.w3.org/TR/page-visibility-2/, https://www.w3.org/TR/permissions/
...
- Unknown WebIDL names used: *DEL* AudioWorklet, MediaSource, MouseEvent, MouseEventInit, RequestCredentials, ServiceWorker, WebGLRenderingContext
...
- Spec is OK: *INS* true / *DEL* false
- Unknown WebIDL names used: *DEL* ExtendableEvent, ExtendableEventInit, ServiceWorker, ServiceWorkerGlobalScope, ServiceWorkerRegistration, VibratePattern
...
- Missing references for links: *DEL* https://w3c.github.io/uievents/, https://w3c.github.io/web-animations/
- Inconsistent references for links: *INS* https://w3c.github.io/uievents/, https://w3c.github.io/web-animations/
...
- Unknown WebIDL names used: *DEL* OrientationLockType, ServiceWorkerUpdateViaCache
...
- WebIDL names also defined elsewhere: *INS* VoidFunction
