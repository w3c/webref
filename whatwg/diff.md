...
- No WebIDL definitions found: *INS* true / *DEL* false
- Obsolete WebIDL constructs found: *DEL* false
- Unknown WebIDL names used: *DEL* Worklet
...
- No WebIDL definitions found: *INS* true / *DEL* false
- Obsolete WebIDL constructs found: *DEL* false
- Missing references for WebIDL names: *DEL* ServiceWorker, ExtendableEvent, ExtendableEventInit, ServiceWorkerGlobalScope
...
- Unknown WebIDL names used: *INS* Document, WorkerGlobalScope
...
- No WebIDL definitions found: *INS* true / *DEL* false
- Obsolete WebIDL constructs found: *DEL* false
- Unknown WebIDL names used: *DEL* Animation, AnimationEffect, AnimationTimeline, CSS, Worklet, WorkletGlobalScope
...
- Obsolete WebIDL constructs found: *DEL* false
- Unknown WebIDL names used: *DEL* Animation, CSSOMString, KeyframeEffectReadOnly
...
- No WebIDL definitions found: *INS* true / *DEL* false
- Obsolete WebIDL constructs found: *DEL* false
- Unknown WebIDL names used: *DEL* CSS, CSSStyleValue, ReadableStream
...
- Unexpected WebIDL definitions found: *INS* false / *DEL* true
- Obsolete WebIDL constructs found: *DEL* false
- Unknown WebIDL names used: *DEL* Animation, CSSOMString
...
- Crawled version: [Initial URL](https://www.w3.org/TR/css-timing-1/)
...
- Crawled version: [Initial URL](https://www.w3.org/TR/css3-page/)
- This specification is not in the new crawl report.
...
- Missing references for links: *DEL* https://w3c.github.io/hr-time/, https://w3c.github.io/performance-timeline/, https://w3c.github.io/paint-timing/, https://w3c.github.io/pointerevents/, https://w3c.github.io/touch-events/
...
- No WebIDL definitions found: *INS* true / *DEL* false
- Obsolete WebIDL constructs found: *DEL* false
- Unknown WebIDL names used: *DEL* Blob, ReadableStream, ReferrerPolicy
...
- Crawled version: [Initial URL](https://www.w3.org/TR/webauthn/)
- This specification is not in the new crawl report.
