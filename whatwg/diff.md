...
- Unknown WebIDL names used: *DEL* DOMRectReadOnly, Point2D
...
- Unknown WebIDL names used: *DEL* Animation, AnimationEffect, AnimationTimeline, CSS, WorkletGlobalScope
...
- Unknown WebIDL names used: *DEL* CSS, CSSStyleValue
...
- Unknown WebIDL names used: *DEL* AudioWorklet, DOMHighResTimeStamp
...
- Unknown WebIDL names used: *DEL* DOMHighResTimeStamp, DOMRectReadOnly, PerformanceEntry
- Missing references for links: *DEL* https://w3c.github.io/performance-timeline/, https://w3c.github.io/hr-time/, https://w3c.github.io/resource-timing/, https://w3c.github.io/IntersectionObserver/
...
- Unknown WebIDL names used: *DEL* Blob, ReferrerPolicy
...
- Spec is OK: *INS* true / *DEL* false
- Unknown WebIDL names used: *DEL* DOMHighResTimeStamp, Sensor, SensorOptions
...
- Unknown WebIDL names used: *DEL* AudioWorklet, Blob, DOMHighResTimeStamp, DOMMatrix, DOMMatrix2DInit, File, FileList, MediaSource, MediaStream, MouseEvent, MouseEventInit, SVGImageElement, SVGScriptElement
...
- Unknown WebIDL names used: *DEL* DOMHighResTimeStamp, PerformanceEntry
- Missing references for links: *DEL* https://w3c.github.io/performance-timeline/, https://w3c.github.io/hr-time/
...
- Unknown WebIDL names used: *DEL* DOMHighResTimeStamp, PerformanceEntry
- Missing references for links: *DEL* https://w3c.github.io/performance-timeline/, https://w3c.github.io/hr-time/, https://w3c.github.io/paint-timing/, https://w3c.github.io/resource-timing/
...
- Unknown WebIDL names used: *DEL* MediaKeySystemAccess, MediaKeysRequirement, Screen
...
- Missing references for links: *DEL* https://www.w3.org/TR/web-intents/
...
- Spec title: *INS* Web Authentication: An API for accessing Public Key Credentials - Level 2 / *DEL* Web Authentication:An API for accessing Public Key Credentials Level 1
- Spec could not be rendered: *DEL* TypeError: Cannot read property 'version-history' of undefined TypeError: Cannot read property 'version-history' of undefined
    at fetch.then.then.s (/home/dom/github.com/reffy/src/lib/util.js:316:34)
    at <anonymous>
    at process._tickCallback (internal/process/next_tick.js:189:7)
