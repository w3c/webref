...
- `DOMHighResTimeStamp` used in [DOM Standard](https://dom.spec.whatwg.org/), [Generic Sensor API](https://w3c.github.io/sensors/), [HTML Standard](https://html.spec.whatwg.org/), [Intersection Observer](https://w3c.github.io/IntersectionObserver/), [MediaStream Recording](https://w3c.github.io/mediacapture-record/), [Web Animations](https://w3c.github.io/web-animations/), [Web Audio API](https://webaudio.github.io/web-audio-api/), [WebRTC 1.0: Real-time Communication Between Browsers](https://w3c.github.io/webrtc-pc/)
...
=> 18 missing references for IDL definitions found in 10 specifications
...
=> 90 missing references for links found in 32 specifications
...
=> 96 inconsistent references for links found in 39 specifications
