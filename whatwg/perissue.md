...
- [Scalable Vector Graphics (SVG) 2](https://svgwg.org/svg2-draft/): `FetchError: request to https://svgwg.org/svg2-draft/single-page.html failed, reason: socket hang up FetchError: request to https://svgwg.org/svg2-draft/single-page.html failed, reason: socket hang up
...
- `DOMHighResTimeStamp` used in [DOM Standard](https://dom.spec.whatwg.org/), [Generic Sensor API](https://w3c.github.io/sensors/), [HTML Standard](https://html.spec.whatwg.org/), [Identifiers for WebRTC's Statistics API](https://w3c.github.io/webrtc-stats/), [MediaStream Recording](https://w3c.github.io/mediacapture-record/), [Web Animations](https://w3c.github.io/web-animations/), [WebRTC 1.0: Real-time Communication Between Browsers](https://w3c.github.io/webrtc-pc/)
...
=> 22 missing references for IDL definitions found in 13 specifications
...
=> 39 missing references for links found in 26 specifications
...
=> 69 inconsistent references for links found in 36 specifications
