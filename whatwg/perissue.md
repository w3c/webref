...
- [CSS Grid Layout Module Level 1](https://www.w3.org/TR/css-grid-1/): `FetchError: invalid json response body at https://api.w3.org/specifications/css-grid-1/versions?embed=1 reason: Unexpected end of JSON input FetchError: invalid json response body at https://api.w3.org/specifications/css-grid-1/versions?embed=1 reason: Unexpected end of JSON input
...
- `DedicatedWorker` used in [File API](https://w3c.github.io/FileAPI/), [WebUSB API](https://wicg.github.io/webusb/)
...
- `SharedWorker` used in [File API](https://w3c.github.io/FileAPI/), [WebUSB API](https://wicg.github.io/webusb/)
...
=> 83 missing references for IDL definitions found in 41 specifications
...
=> 346 missing references for links found in 121 specifications
...
=> 183 inconsistent references for links found in 90 specifications
