...
- `MessagePort` used in [Web Audio API](https://webaudio.github.io/web-audio-api/)
...
- `ServiceWorkerRegistration` used in [Background Fetch](https://wicg.github.io/background-fetch/), [Notifications API Standard](https://notifications.spec.whatwg.org/), [Payment Handler API](https://w3c.github.io/payment-handler/), [Push API](https://w3c.github.io/push-api/), [Web Background Synchronization](https://wicg.github.io/BackgroundSync/spec/)
...
=> 16 missing references for IDL definitions found in 10 specifications
