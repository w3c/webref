...
- Spec is OK: *INS* true / *DEL* false
- Missing references for WebIDL names: *DEL* Window, Worker, Worklet
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/WD-css-fonts-4-20191113/)
...
- Inconsistent references for links: *INS* https://www.w3.org/TR/css-fonts-4/, https://www.w3.org/TR/2018/WD-css-fonts-4-20180920/
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/WD-css-text-4-20191113/)
- Editor's Draft: [https://drafts.csswg.org/css-text-4/](https://drafts.csswg.org/css-text-4/)
- Repository: [GitHub w3c/csswg-drafts](https://github.com/w3c/csswg-drafts)
- Missing references for links: *INS* https://www.w3.org/TR/selectors4/, https://www.w3.org/TR/css3-background/ / *DEL* https://www.w3.org/TR/css3-break/
...
- Unknown WebIDL names used: *DEL* LayoutWorklet, PaintWorklet
- Missing references for WebIDL names: *DEL* Window, Worker
...
- Missing references for links: *INS* https://w3c.github.io/uievents/, https://html.spec.whatwg.org/, https://www.w3.org/TR/uievents/, https://dom.spec.whatwg.org/, https://infra.spec.whatwg.org/, https://www.w3.org/TR/cssom-1/, https://www.w3.org/TR/fingerprinting-guidance/
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/WD-screen-capture-20191119/)
...
- Unknown WebIDL names used: *DEL* NavigatorUserMedia
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/WD-appmanifest-20191115/)
...
- Missing references for WebIDL names: *DEL* Window, EventHandler
