% Diff between report from "September 30, 2019" and reference report from "September 23, 2019"
% Reffy
% September 30, 2019
...
- Unknown WebIDL names used: *INS* ImageBitmapSource, Window
...
- Unknown WebIDL names used: *INS* HTMLIFrameElement, Window
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/WD-gamepad-20190923/)
...
- Unknown WebIDL names used: *INS* DedicatedWorker, Window
...
- Unknown WebIDL names used: *INS* HTMLVideoElement, Window
...
- Unknown WebIDL names used: *INS* Navigator, Window / *DEL* bool
...
- Unknown WebIDL names used: *INS* EventHandler, Window
- Missing references for WebIDL names: *INS* Worker
- Missing references for links: *DEL* https://w3c.github.io/payment-method-manifest/
...
- Unknown WebIDL names used: *INS* EventHandler, HTMLVideoElement, Window
...
- Unknown WebIDL names used: *INS* EventHandler, GlobalEventHandlers, Navigator, Window
...
- Unknown WebIDL names used: *INS* EventHandler, MessagePort, Navigator, PostMessageOptions, Window, WindowOrWorkerGlobalScope, WorkerGlobalScope, WorkerNavigator, WorkerType
...
- Missing references for WebIDL names: *DEL* HTMLLinkElement, HTMLScriptElement
...
- Crawled version: [Latest published version](https://www.w3.org/TR/2019/WD-appmanifest-20190926/)
- Editor's Draft: [https://w3c.github.io/manifest/](https://w3c.github.io/manifest/)
- Repository: [GitHub w3c/manifest](https://github.com/w3c/manifest)
- Unknown WebIDL names used: *INS* EventHandler, Window, WorkerType
...
- Repository: [GitHub KhronosGroup/WebGL](https://github.com/KhronosGroup/WebGL)
- Spec is OK: *INS* false / *DEL* true
- Unknown WebIDL names used: *INS* HTMLCanvasElement, HTMLImageElement, HTMLVideoElement, ImageBitmap, ImageData, OffscreenCanvas, Window
- Missing references for WebIDL names: *INS* Worker
...
- Inconsistent references for links: *INS* https://www.w3.org/TR/webrtc-identity/
...
- Unknown WebIDL names used: *INS* DedicatedWorker, EventHandler, Navigator, SharedWorker, Window, WorkerNavigator
...
- Unknown WebIDL names used: *INS* TextTrackCue, Window
