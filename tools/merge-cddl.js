/**
 * Merge CDDL modules defined across specs.
 *
 * This is typically useful for WebDriver BiDi, where the main spec defines the
 * core local and remote-end CDDL modules, that then get extended as needed in
 * other specifications such as Digital Credentials, or Web Bluetooth.
 *
 * node tools/merge-cddl.js [folder]
 * 
 * ... where:
 * - [folder] is the name of the folder that contains the data to parse and
 * update (default is "curated")
 *
 * Note: There would ideally be a way to spot
 */
